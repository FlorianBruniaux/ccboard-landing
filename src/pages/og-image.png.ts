...
export const GET: APIRoute = async () => {
  const stats = [
    { value: '11', label: 'TABS' },
    { value: '89x', label: 'FASTER' },
    { value: '5.8MB', label: 'BINARY' },
    { value: '377', label: 'TESTS' },
  ]
        ...
        children: [
          ...
          // Subtitle
          {
            ...
            props: {
              ...
              children: 'The Dashboard Claude Code Deserves',
            },
          },
          // Stats row
          {
